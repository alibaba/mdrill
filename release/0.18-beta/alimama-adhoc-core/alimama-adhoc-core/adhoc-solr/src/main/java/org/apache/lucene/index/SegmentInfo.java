...
public final class SegmentInfo implements Cloneable {
    ...
    if (format <= SegmentInfos.FORMAT_LOCKLESS) {
      ...
      if (format <= SegmentInfos.FORMAT_HAS_VECTORS) {
        ...
        if (docStoreOffset != -1) {
          ...
          extpos=IndexFileNames.COMPOUND_FILE_STORE_EXTENSION_POS;
        } else {
          storesSegment = name;
          isCompoundFile = getUseCompoundFile();
          ext = IndexFileNames.COMPOUND_FILE_EXTENSION;
          extpos=IndexFileNames.COMPOUND_FILE_EXTENSION_POS;
        }
  ...
  public List<String> files() throws IOException {
    ...
    if (useCompoundFile) {
      ...
      filesSet.add(IndexFileNames.segmentFileName(name, IndexFileNames.COMPOUND_FILE_EXTENSION_POS));
    ...
    if (docStoreOffset != -1) {
      ...
      if (docStoreIsCompoundFile) {
        ...
        filesSet.add(IndexFileNames.segmentFileName(docStoreSegment, IndexFileNames.COMPOUND_FILE_STORE_EXTENSION_POS));
