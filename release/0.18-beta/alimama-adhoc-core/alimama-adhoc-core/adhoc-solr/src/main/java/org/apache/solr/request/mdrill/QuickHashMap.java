 ...
 */
public QuickHashMap(Map<? extends K, ? extends V> m) {
...
static class Entry<K,V> implements Map.Entry<K,V> {
     ...
     * in the HashMap.
     */
    void recordAccess(QuickHashMap<K,V> m) {
    }
     ...
     */
    void recordRemoval(QuickHashMap<K,V> m) {
    }
}
...
private final class KeySet extends AbstractSet<K> {
    ...
    public boolean remove(Object o) {
        return QuickHashMap.this.removeEntryForKey(o) != null;
    }
    public void clear() {
