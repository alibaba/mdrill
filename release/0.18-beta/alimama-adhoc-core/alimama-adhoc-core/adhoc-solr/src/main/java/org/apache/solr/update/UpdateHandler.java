 ...
 *
 * @version $Id: UpdateHandler.java 1100480 2011-05-07 08:37:00Z uschindler $
 * @since solr 0.9
 */

public abstract class UpdateHandler implements SolrInfoMBean {
	public static String UPDATEPARTION="higoupdate";
...
//    return new SolrIndexWriter(name,core.getIndexDir(UpdateHandler.UPDATEPARTION), core.getDirectoryFactory(), removeAllExisting, schema, core.getSolrConfig().mainIndexConfig, core.getDeletionPolicy());
//  }
//
