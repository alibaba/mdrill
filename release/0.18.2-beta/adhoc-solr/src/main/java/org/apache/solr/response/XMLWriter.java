...
/**
 * @version $Id: XMLWriter.java 1171741 2011-09-16 19:29:23Z hossman $
 */
final public class XMLWriter {
  ...
  public final void writeSolrDocumentList(String name, final SolrDocumentList docs, Set<String> fields) throws IOException 
  {
    ...
    {  
      ...
      public double getSum() { return docs.getSum(); }
      public double getMin() { return docs.getMin(); }
      public double getMax() { return docs.getMax(); }
  ...
  public final void writeDocList(String name, final DocList ids, Set<String> fields) throws IOException 
  {
    ...
    {  
      ...
      public double getSum() { return ids.sum(); }
      public double getMin() { return ids.min(); }
      public double getMax() { return ids.max(); }
