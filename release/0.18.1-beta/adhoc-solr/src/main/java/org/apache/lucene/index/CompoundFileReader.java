...
class CompoundFileReader extends Directory {
  ...
  public CompoundFileReader(Directory dir, String name,String posname) throws IOException {
    this(dir, name,posname, BufferedIndexInput.BUFFER_SIZE);
  }
  
  public CompoundFileReader(Directory dir, String name,String posname, int readBufferSize) throws IOException {
	...
	pos.put(key, value);
	  ...
	  long opos=stream.getFilePointer();

        long offset = stream.readLong();
        if(pos.containsKey(opos))
        {
            offset=pos.get(opos);
//            System.out.println("###opos"+opos+","+offset);
        }
