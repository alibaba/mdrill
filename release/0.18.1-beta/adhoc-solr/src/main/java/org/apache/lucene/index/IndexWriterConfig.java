...
public final class IndexWriterConfig implements Cloneable {
    ...
    private static Boolean isCompressFrq=false;
    private static Integer maxBlockSize=10240;
    public static void setFrqCompress(java.lang.Boolean isuse,Integer maxBlockSize)
    {
	System.out.println("########isusecompress:"+isuse+","+maxBlockSize);
	IndexWriterConfig.isCompressFrq=isuse;
	IndexWriterConfig.maxBlockSize=maxBlockSize;
    }
    
    public static boolean IsCompressFrq()
    {
	return IndexWriterConfig.isCompressFrq;
    }
    
    public static Integer getMaxBlockSize()
    {
	return IndexWriterConfig.maxBlockSize;
    }
  /**
