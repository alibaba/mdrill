...
<li><a href="https://github.com/alibaba/mdrill/blob/master/doc/INSTALL.docx?raw=true" target="_blank">安装部署(由延年早起提供)</a></li>
<li><a href="https://github.com/alibaba/mdrill/blob/master/doc/INSTALL_SINGLE.txt?raw=true" target="_blank">单机版安装部署（由范宜坚(@yehaozi)提供）</a></li>
<li><a href="https://github.com/alibaba/mdrill/blob/master/doc/INSTALL_SINGLE.txt?raw=true" target="_blank">基于kafka的实时模式部署（由研究院移动互联网研究室移动互联网服务项目组提供）</a></li>
