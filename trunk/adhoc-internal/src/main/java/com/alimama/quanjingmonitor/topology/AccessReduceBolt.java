...
/**
create table quanjingmointor_access(
 	thedate string ,
 	hour string ,
 	miniute tdate ,
 	pid string,
 ...
 */
public class AccessReduceBolt implements IRichBolt {
	private static Logger LOG = Logger.getLogger(AccessReduceBolt.class);
    private static final long serialVersionUID = 1L;
  
    public String type="";
    public AccessReduceBolt(String type) {
		this.type = type;
	}

	private OutputCollector collector=null;
	private volatile long index=0;
	private HashMap<BoltStatKey, AccessStatVal> nolockbuffer=null;

	private Access_LastTimeBolt_chain lasttimeUp_chain1=null;//new LastTimeBolt();
    ...
    public void prepare(Map stormConf, TopologyContext context,
    	...
    	this.lasttimeUp_chain1=new Access_LastTimeBolt_chain(this);
    	this.collector=collector;
    	this.nolockbuffer=new HashMap<BoltStatKey, AccessStatVal>(10000);
    }
