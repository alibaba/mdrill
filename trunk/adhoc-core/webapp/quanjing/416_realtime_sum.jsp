...
<h2><a style="color:#551890" href="././416_realtime.jsp">分时数据</a>/累计数据/<a style="color:#551890" href="././416_table.jsp">离线数据</a></h2>
...
<td>			
			...
			<tr>
				 ...
				 <td> 	 	<input type="text" name="searchkeyword" id="searchkeyword" value="*MOP*"  />
...
function makeDataSet()
{
		...
		labelName["saoma_pv_sum"]="0";
	}else{
				labelName["spv_huodong_sum"]="0";
		labelName["sclick_huodong_sum"]="0";
		//labelName["spv_zhadui_sum"]="0";
		//labelName["sclick_zhadui_sum"]="0";
		labelName["aclick_sum"]="1";
