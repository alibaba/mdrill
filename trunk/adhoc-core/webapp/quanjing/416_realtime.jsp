...
<h2>分时数据/<a style="color:#551890" href="././416_realtime_sum.jsp">累计数据</a>/<a style="color:#551890" href="././416_table.jsp">离线数据</a></h2>
...
function makeDataSet()
{
		...
		labelName["spv"]="0";
		labelName["sclick"]="0";
		labelName["saoma_pv"]="0";
	}else{
				labelName["spv_huodong"]="0";
		labelName["sclick_huodong"]="0";
		//labelName["spv_zhadui"]="0";
		//labelName["sclick_zhadui"]="0";
		labelName["aclick"]="1";
