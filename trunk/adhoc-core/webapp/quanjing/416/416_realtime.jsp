...
<div style="font-size:50px; border:double; width:210px; text-align:center; vertical-align:middle">全景监控</div>
 	<h1><a style="color:#551890" href="./siteoverlap.jsp">流量分析</a>/3.8生活节/<a style="color:#551890" href="./tanxpv.jsp">TANX外投流量指标</a>/<a style="color:#551890" href="./tanx_table.jsp">TANX外投流量数据排行</a></h1>
...
<td>		  
			  ...
			  <table id="pidtbl" border="0" cellspacing="0" cellpadding="0"> 
			   ...
			   <td> 	 	<input type="text" name="thetplid" id="thetplid" value="1"  />
			</td>
			 </tr>
			</table>	
	</td>
