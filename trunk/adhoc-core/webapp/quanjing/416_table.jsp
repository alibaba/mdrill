...
<h2><a style="color:#551890" href="././416_realtime.jsp">分时数据</a>/<a style="color:#551890" href="././416_realtime_sum.jsp">累计数据</a>/离线数据</h2>
...
{	
	...
	datastr:resultliststr,
	 height: 600,
	 colNames:['日期',  '广告位ID','一跳点击','二跳pv','二跳uv','二跳点击','二跳点击uv','扫码PV','扫码UV'

	 ], 
	 colModel:[ 
	  {name:'thedate',index:'thedate', width:80,searchoptions:{"clearSearch":false,sopt:['eq']}}, 
	 
	  {name:'pid',index:'pid', width:250,searchoptions:{"clearSearch":false,sopt:['eq']}}, 
    {name:'aclick',index:'aclick', width:100, align:"right",sorttype:"float",searchoptions:{clearSearch:false,sopt:['eq','ne','le','lt','gt','ge']}},
	 ...
	 {name:'sclickuv',index:'sclickuv', width:100, align:"right",sorttype:"float",searchoptions:{clearSearch:false,sopt:['eq','ne','le','lt','gt','ge']}},
	 {name:'saoma_pv',index:'saoma_pv', width:100, align:"right",sorttype:"float",searchoptions:{clearSearch:false,sopt:['eq','ne','le','lt','gt','ge']}},
	 {name:'saoma_uv',index:'saoma_uv', width:100, align:"right",sorttype:"float",searchoptions:{clearSearch:false,sopt:['eq','ne','le','lt','gt','ge']}}
	 ], 
	  pager: '#pager2',
	  rowNum:200, 
	...
	datastr:resultliststr,
	 height: 600,
	 colNames:['日期', '媒体名称', '广告位名称','广告位ID','pidsize','tid','一跳点击','当日承诺点击','H5活动页面PV','H5活动页面UV'
	 ,'H5活动页面点击','H5活动页面点击UV'

	 ], 
	 colModel:[ 
	  {name:'thedate',index:'thedate', width:80,searchoptions:{"clearSearch":false,sopt:['eq']}}, 
	  {name:'sitename',index:'sitename', width:100,searchoptions:{"clearSearch":false,sopt:['eq']}}, 
	  ...
	  {name:'pidsize',index:'pidsize', width:250,searchoptions:{"clearSearch":false,sopt:['eq']}}, 
	  {name:'isjs',index:'isjs', width:250,searchoptions:{"clearSearch":false,sopt:['eq']}}, 
	 ...
	 {name:'s_huodong_pv',index:'s_huodong_pv', width:100, align:"right",sorttype:"float",searchoptions:{clearSearch:false,sopt:['eq','ne','le','lt','gt','ge']}},
	 {name:'s_huodong_uv',index:'s_huodong_uv', width:100, align:"right",sorttype:"float",searchoptions:{clearSearch:false,sopt:['eq','ne','le','lt','gt','ge']}},
	 {name:'s_huodong_click',index:'s_huodong_click', width:100, align:"right",sorttype:"float",searchoptions:{clearSearch:false,sopt:['eq','ne','le','lt','gt','ge']}},
	 {name:'s_huodong_clickuv',index:'s_huodong_clickuv', width:100, align:"right",sorttype:"float",searchoptions:{clearSearch:false,sopt:['eq','ne','le','lt','gt','ge']}}
	// {name:'s_zhadui_pv',index:'s_huodong_clickuv', width:100, align:"right",sorttype:"float",searchoptions:{clearSearch:false,sopt:['eq','ne','le','lt','gt','ge']}},
	// {name:'s_zhadui_uv',index:'s_huodong_clickuv', width:100, align:"right",sorttype:"float",searchoptions:{clearSearch:false,sopt:['eq','ne','le','lt','gt','ge']}},
	// {name:'s_zhadui_click',index:'s_huodong_clickuv', width:100, align:"right",sorttype:"float",searchoptions:{clearSearch:false,sopt:['eq','ne','le','lt','gt','ge']}},
	// {name:'s_zhadui_clickuv',index:'s_huodong_clickuv', width:100, align:"right",sorttype:"float",searchoptions:{clearSearch:false,sopt:['eq','ne','le','lt','gt','ge']}},
	// {name:'call_client_cnt',index:'call_client_cnt', width:100, align:"right",sorttype:"float",searchoptions:{clearSearch:false,sopt:['eq','ne','le','lt','gt','ge']}},
...
function fetch_pc_day(thedate,fn,failfn)
{
	  ...
	  newq.push({"thedate":{"operate":1,"value":[thedate]}});
	  	...
	  	var requestparams={};
			...
			requestparams.project="rpt_quanjing_416_pc";
			requestparams.fl="thedate,site_name,pid,aclick,spv,suv,sclick,sclickuv,saoma_pv,saoma_uv";
		  requestparams.q=JSON.stringify(newq);
			...
			$.post("/result.jsp",requestparams,
					function (data, textStatus){	
						...
						{
							alert("你没有权限看下如下的pid,已经对其进行了过滤:"+JSON.stringify(forbidpidlist));
						}
...
function fetch_wireless_day(thedate,fn,failfn)
{
	  ...
	  newq.push({"thedate":{"operate":1,"value":[thedate]}});
	  	...
	  	var requestparams={};
			requestparams.start=0;
			requestparams.rows=10000;
			requestparams.project="rpt_quanjing_416_wireless";
			requestparams.fl="thedate,sitename,resource_name,resource_id,pidsize,isjs,aclick,promise_aclick,s_huodong_pv,s_huodong_uv,s_huodong_click,s_huodong_clickuv,s_zhadui_pv,s_zhadui_uv,s_zhadui_click,s_zhadui_clickuv,call_client_cnt,call_client_uv,download_client_pv,download_client_uv";
			requestparams.q=JSON.stringify(newq);
