...
public class TopFieldDocs extends TopDocs {
	 ...
	 */
        public TopFieldDocs (int totalHits, ScoreDoc[] scoreDocs, SortField[] fields,
        		float maxScore, double sum, double max, double min) {
	  super (totalHits, scoreDocs, maxScore, sum, max, min);
	  this.fields = fields;
	}
}