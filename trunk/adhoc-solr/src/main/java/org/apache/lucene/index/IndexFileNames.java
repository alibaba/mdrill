...
public final class IndexFileNames {
  ...
  public static final String SEGMENTS_CHECKSUM = "yn_segments_crc";
  ...
  /** Extension of terms file */
  public static final String TERMS_EXTENSION_SIZE = "yntis";
  ...
  public static final String TERMS_EXTENSION_QUICK_OLD = "quicktis";
  public static final String TERMS_EXTENSION_QUICK = "doctotm";
  public static final String TERMS_EXTENSION_QUICK_TXT = "tmtorealval";
  public static final String TERMS_EXTENSION_QUICK_VAL = "tmtonumval";
  ...
  public static final String COMPOUND_FILE_EXTENSION_POS = "yncfs";

  /** Extension of compound file for doc store files*/
  public static final String COMPOUND_FILE_STORE_EXTENSION = "cfx";
  
  public static final String COMPOUND_FILE_STORE_EXTENSION_POS = "yncfx";
  ...
  public static final String INDEX_EXTENSIONS[] = new String[] {
    ...
    TERMS_EXTENSION,
    TERMS_EXTENSION_QUICK_OLD,
    TERMS_EXTENSION_QUICK,
    TERMS_EXTENSION_QUICK_TXT,
    TERMS_EXTENSION_QUICK_VAL,
    ...
    COMPOUND_FILE_STORE_EXTENSION_POS
  };
