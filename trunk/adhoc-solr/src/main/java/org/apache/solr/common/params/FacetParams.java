...
public interface FacetParams {
  ...
  public static final String FACET_CROSS_OFFSET = FACET + ".cross.offset";
//  public static final String FACET_CROSS_PAGENUM = FACET + ".cross.pagenum";
  public static final String FACET_CROSS_FL = FACET + ".cross.fl";
  public static final String FACET_CROSS_FL_PRE_GROUPS = FACET + ".cross.fl.pre";

  public static final String FACET_CROSSDIST_FL = FACET + ".crossdist.fl";
  public static final String FACET_CROSS_LIMIT = FACET + ".cross.limit";
  public static final String FACET_CROSS_MAXLIMIT = FACET + ".maxlimit";
  public static final String FACET_CROSS = FACET + ".cross";
...
//  public static final String IS_SUB_SHARDS="merger.shards.issub";
  ...
  public static final String FACET_CROSS_SORT_FL = FACET + ".cross.sort.fl";
  public static final String FACET_CROSS_SORT_TYPE = FACET + ".cross.sort.tp";
  public static final String FACET_CROSS_SORT_ISDESC = FACET + ".cross.sort.desc";
  /**
